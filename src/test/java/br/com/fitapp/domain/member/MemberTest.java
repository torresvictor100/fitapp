package br.com.fitapp.domain.member;
...
public class MemberTest {
    ...
    public void member(){
        ...
        final var member = new Member(photoUrl, discription,name);
    ...
    @Test
    public void memberExecption(){

        final var photoUrl = "photoUrl";
        final var discription = "discription";

        Assertions.assertThrows(NullPointerException.class,() -> {
            new Member(photoUrl, discription,null);
        });
    }
}
